 ...
 *
 */
public class BatConfigGuiFactory implements IModGuiFactory {
	...
	public static class BoeConfigGui extends GuiConfig {
		...
		public static class CategoryEntryBlocks extends CategoryEntry {
			...
			protected GuiScreen buildChildScreen() {
				Configuration config = BatConfig.getConfig();
				ConfigElement categoryBlocks = new ConfigElement(config.getCategory(BatConfig.CATEGORY_NAME_BLOCKS));
