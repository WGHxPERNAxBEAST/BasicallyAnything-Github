...
public class BlockTinButton extends BlockButton {
	...
	protected void playClickSound(EntityPlayer player, World worldIn, BlockPos pos) {
		worldIn.playSound(player, pos, BatSoundHandler.TIN_BUTTON_CLICK_ON, SoundCategory.BLOCKS, 1.0F, 1.0F);
	}
	...
	protected void playReleaseSound(World worldIn, BlockPos pos) {
		worldIn.playSound((EntityPlayer)null, pos, BatSoundHandler.TIN_BUTTON_CLICK_OFF, SoundCategory.BLOCKS, 1.0F, 1.0F);
	}
